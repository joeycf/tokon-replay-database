...
| hadoukenReplays | 769 | 73 | 9.5% |
| replaysHub | 130 | 126 | 96.9% |
| fightingStationX | 2690 | 97 | 3.6% |
| fgcReplaysHub | 2548 | 17 | 0.7% |
| marvelTokonYT _(events only)_ | 40 | 11 | 27.5% |
| **total** | | **435** | |

## Character provenance

How every one of the 870 sides got its characters.

| tier | sides | share |
| --- | ---: | ---: |
| title | 54 | 6.2% |
| description | 241 | 27.7% |
| footage | 32 | 3.7% |
| human | 519 | 59.7% |
| review | 24 | 2.8% |

- complete (4/4): **816/870** (93.8%)
- oversize (>4, mid-set team change): **7** — counted in usage, excluded from pairing
- bench alignment: handle 229 · character-subset 21 · ambiguous 4
- title slot order: handle-first 697 · chars-first 71 · parallel-lists 80
...
- **54 side(s) awaiting a drain** across 27 record(s) — oldest published **12 day(s)** ago
